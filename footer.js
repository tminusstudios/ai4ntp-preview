/* AI4NTP global footer.
   ...
   Inject with <script src="/ai4ntp-preview/footer.js"></script> where the footer should appear
...
(function () {
  var CSS = [
    ...
    '.ai4ft-logo{font-family:"Fraunces",Georgia,serif;font-weight:700;font-size:26px;letter-spacing:-.02em;text-transform:none;text-decoration:none;color:#FAF7F0;display:inline-block;margin-bottom:18px;}',
    '.ai4ft-logo .four{background:#D4FF3A;color:#0F1113;padding:0 6px;margin:0 1px;border-radius:2px;font-style:italic;}',
    ...
    '.ai4ft-cta{display:inline-flex;align-items:center;gap:8px;background:#D4FF3A;color:#0F1113;text-decoration:none;padding:13px 22px;border-radius:999px;font-family:"JetBrains Mono","SF Mono",monospace;font-size:11px;letter-spacing:.14em;text-transform:uppercase;transition:background .2s,transform .2s;}',
    '.ai4ft-cta:hover{background:#FAF7F0;transform:translateY(-1px);}',
    '.ai4ft-col h4{font-family:"JetBrains Mono","SF Mono",monospace;font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:#FAF7F0;opacity:.45;margin:0 0 16px;}',
    ...
    '<footer class="ai4ft" aria-label="Site footer">' +
      '<div class="ai4ft-top">' +
        '<div class="ai4ft-brand">' +
          '<a class="ai4ft-logo" href="/ai4ntp-preview/">ai<span class="four">4</span>ntp</a>' +
          ...
          '<a class="ai4ft-cta" href="/ai4ntp-preview/register" data-cta="footer_save_seat_click">Save your seat &rarr;</a>' +
        '</div>' +
        '<div class="ai4ft-links">' +
        '<div class="ai4ft-col">' +
          '<h4>Sessions</h4>' +
          '<a href="/ai4ntp-preview/sessions">All sessions</a>' +
          '<a href="/ai4ntp-preview/sessions/005">Episode 005 replay</a>' +
          '<a href="/ai4ntp-preview/sessions/004">Episode 004 replay</a>' +
          '<a href="/ai4ntp-preview/sessions/003">Episode 003 replay</a>' +
          '<a href="/ai4ntp-preview/sessions/002">Episode 002 replay</a>' +
          '<a href="/ai4ntp-preview/ai-tools">AI tools directory</a>' +
          '<a href="/ai4ntp-preview/blog">Field notes</a>' +
          '<a href="/ai4ntp-preview/register">Reserve your seat</a>' +
        '</div>' +
        '<div class="ai4ft-col">' +
          '<h4>Get involved</h4>' +
          '<a href="/ai4ntp-preview/about">About AI4NTP</a>' +
          '<a href="/ai4ntp-preview/refer">Refer &amp; earn</a>' +
          '<a href="/ai4ntp-preview/partner">Apply to be a guest</a>' +
          '<a href="/ai4ntp-preview/partner#apply">Sponsor</a>' +
        '</div>' +
        '<div class="ai4ft-col">' +
          '<h4>Socials</h4>' +
      ...
      '<div class="ai4ft-bottom">' +
        ...
        '<span class="ai4ft-legal"><a href="/ai4ntp-preview/privacy">Privacy</a><a href="/ai4ntp-preview/terms">Terms</a></span>' +
