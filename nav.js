/* AI4NTP global site header: countdown bar + nav.
   ...
   Include with <script src="/ai4ntp-preview/nav.js"></script> right after the opening <body> tag.
...
(function () {
  ...
  var CSS = [
    ...
    '.ai4nav-cd{background:#0F1113;color:#FAF7F0;display:flex;align-items:center;justify-content:center;gap:16px;padding:9px 24px;font-family:"JetBrains Mono","SF Mono",monospace;font-size:11px;letter-spacing:0.1em;text-transform:uppercase;flex-wrap:wrap;border-bottom:1px solid rgba(250,247,240,.1);}',
    ...
    '.ai4nav-link{font-family:"JetBrains Mono","SF Mono",monospace;font-size:11px;letter-spacing:.12em;text-transform:uppercase;text-decoration:none;color:#FAF7F0;opacity:.6;transition:opacity .2s;background-image:linear-gradient(#D4FF3A,#D4FF3A);background-size:0% 1px;background-repeat:no-repeat;background-position:0 100%;padding-bottom:3px;transition:opacity .2s,background-size .45s cubic-bezier(.22,1,.36,1);}',
    '.ai4nav-link:hover{opacity:1;background-size:100% 1px;}',
    '.ai4nav-cta{display:inline-flex;align-items:center;gap:8px;background:#0F1113;color:#FAF7F0;text-decoration:none;padding:10px 18px;border:1px solid #0F1113;border-radius:999px;font-family:"JetBrains Mono","SF Mono",monospace;font-size:11px;letter-spacing:.12em;text-transform:uppercase;transition:background .2s,color .2s,border-color .2s,transform .25s,box-shadow .25s;}',
    ...
    '.ai4nav-panel a{padding:15px 4px;text-decoration:none;color:#FAF7F0;font-family:"JetBrains Mono","SF Mono",monospace;font-size:13px;letter-spacing:.08em;text-transform:uppercase;border-top:1px solid rgba(250,247,240,.08);}',
  ...
  var HTML =
    '<header class="ai4nav">' +
      '<div class="ai4nav-cd">' +
        ...
        '<a class="ai4nav-cdcta" id="ai4nav-cdcta" href="/ai4ntp-preview/sessions/006" data-cta="countdown_cta_click">Save your seat →</a>' +
      '</div>' +
      '<nav class="ai4nav-bar">' +
        '<a class="ai4nav-logo" href="/ai4ntp-preview/">ai<span class="ai4nav-four">4</span>ntp</a>' +
        '<div class="ai4nav-right">' +
          '<div class="ai4nav-links">' +
            '<a class="ai4nav-link" href="/ai4ntp-preview/sessions" data-cta="nav_sessions_click">Sessions</a>' +
            '<a class="ai4nav-link" href="/ai4ntp-preview/ai-tools" data-cta="nav_tools_click">AI Tools</a>' +
            '<a class="ai4nav-link" href="/ai4ntp-preview/blog" data-cta="nav_blog_click">Blog</a>' +
          '</div>' +
          '<a class="ai4nav-cta ai4nav-cta--signal" href="/ai4ntp-preview/sessions/006" data-cta="nav_save_seat_click">Save your seat →</a>' +
      ...
      '<div class="ai4nav-panel" id="ai4nav-panel">' +
        '<a href="/ai4ntp-preview/sessions" data-cta="navm_sessions_click">Sessions</a>' +
        '<a href="/ai4ntp-preview/ai-tools" data-cta="navm_tools_click">AI Tools</a>' +
        '<a href="/ai4ntp-preview/blog" data-cta="navm_blog_click">Blog</a>' +
        '<a href="/ai4ntp-preview/sessions/006" data-cta="navm_save_seat_click">Save your seat →</a>' +
      '</div>' +
    '</header>';
  ...
  function render() {
    ...
    if (new Date() < EVENT_END) {
      ...
      if (cdCta) { cdCta.textContent = 'Join or register →'; cdCta.setAttribute('href', '/ai4ntp-preview/sessions/006'); }
    } else {
      if (cdLabel) cdLabel.textContent = 'Session 006 has wrapped';
      if (cdCta) { cdCta.textContent = 'Show notes →'; cdCta.setAttribute('href', '/ai4ntp-preview/sessions/006'); }
    }
  }
