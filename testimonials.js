/* AI4NTP global testimonials wall (static masonry).
   ...
   <script src="/ai4ntp-preview/testimonials.js"></script> where the section should appear.
  ...
  var DATA = [
    {
      ...
      location: "San Francisco, USA", photo: "/ai4ntp-preview/testimonials/headshots/susan-delia.jpg", initials: "SD"
    },
    {
      ...
      location: "New York, USA", photo: "/ai4ntp-preview/testimonials/headshots/peggy-tsai.jpg", initials: "PT"
    },
    {
      ...
      location: "Manila, Philippines", photo: "/ai4ntp-preview/testimonials/headshots/mark-yoldi.jpg", initials: "MY"
    },
    {
      ...
      location: "Texas, USA", photo: "/ai4ntp-preview/testimonials/headshots/farha-akhtar.jpg", initials: "FA"
    },
    {
      ...
      location: "West Palm Beach, USA", photo: "/ai4ntp-preview/testimonials/headshots/johan-jimenez.jpg", initials: "JJ"
    },
    {
      ...
      location: "San Francisco, USA", photo: "/ai4ntp-preview/testimonials/headshots/jennie-kimmel.jpg", initials: "JK"
    },
    {
      ...
      location: "Atlanta, USA", photo: "/ai4ntp-preview/testimonials/headshots/sydney-kida-timmers.jpg", initials: "ST"
    },
    {
      ...
      location: "Oceanside, USA", photo: "/ai4ntp-preview/testimonials/headshots/kristin-daroza.jpg", initials: "KD"
    }
  ];

  var CSS = [
    '.ai4tm{background:#0F1113;color:#FAF7F0;padding:88px 0;border-top:1px solid rgba(15,17,19,.12);position:relative;z-index:2;font-family:-apple-system,BlinkMacSystemFont,"Helvetica Neue",Helvetica,Arial,sans-serif;}',
    '.ai4tm *{box-sizing:border-box;}',
    '.ai4tm-head{max-width:760px;margin:0 auto 44px;padding:0 24px;text-align:center;}',
    '.ai4tm-eyebrow{font-family:"JetBrains Mono","SF Mono",monospace;font-size:11px;letter-spacing:.18em;text-transform:uppercase;opacity:.5;margin-bottom:18px;}',
    '.ai4tm-title{font-family:"Fraunces",Georgia,serif;font-weight:300;font-size:clamp(28px,4.4vw,48px);letter-spacing:-.03em;line-height:1.04;}',
    '.ai4tm-title em{font-family:"Instrument Serif",Georgia,serif;font-style:italic;font-weight:400;}',
    /* static masonry wall */
    '.ai4tm-grid{max-width:1180px;margin:0 auto;padding:0 40px;column-count:3;column-gap:20px;}',
    ...
    '.ai4tm-av::before{content:attr(data-initials);position:absolute;font-family:"Fraunces",Georgia,serif;font-weight:300;font-size:18px;color:rgba(212,255,58,.6);}',
    '.ai4tm-av img{position:relative;z-index:1;width:100%;height:100%;object-fit:cover;display:block;}',
    '.ai4tm-meta{min-width:0;}',
    '.ai4tm-name{font-family:"Fraunces",Georgia,serif;font-weight:600;font-size:15px;letter-spacing:-.01em;color:#FAF7F0;text-decoration:none;}',
    '.ai4tm-name:hover{color:#D4FF3A;}',
    '.ai4tm-role{font-size:12.5px;line-height:1.35;opacity:.82;margin-top:3px;}',
    '.ai4tm-role a{color:#D4FF3A;text-decoration:none;}',
    '.ai4tm-role a:hover{text-decoration:underline;}',
    '.ai4tm-loc{font-family:"JetBrains Mono","SF Mono",monospace;font-size:9.5px;letter-spacing:.14em;text-transform:uppercase;opacity:.5;margin-top:7px;}'
  ].join('');
